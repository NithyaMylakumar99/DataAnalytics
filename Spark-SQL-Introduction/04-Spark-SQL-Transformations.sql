...
FROM daily_pricing_csv_managed LIMIT 10


-- COMMAND ----------

SELECT PRODUCT_NAME, ARRIVAL_IN_TONNES, ARRIVAL_IN_TONNES * 1000 AS ARRIVAL_IN_KILOGRAMS
FROM daily_pricing_csv_managed
...
CREATE TABLE daily_pricing_aggregate_manages_table AS
SELECT STATE_NAME,
PRODUCT_NAME, 
SUM(ARRIVAL_IN_TONNES) AS TOTAL_ARRIVAL_IN_TONNES
FROM daily_pricing_csv_managed
